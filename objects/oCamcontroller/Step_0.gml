...
// Wenn die Kamera noch nicht zentriert wurde
if (!camera_instantly_placed) {
    // Sofortige Zentrierung ohne Easing
    camera_set_view_pos(cam, target_x, target_y);
    camera_instantly_placed = true; // Setze die Zentrierung als abgeschlossen
} else {
    // Easing wird angewendet, nachdem die Kamera zentriert ist
